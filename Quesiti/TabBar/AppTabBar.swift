...
class AppTabBar: UITabBar {
    ...
    func createPath() -> CGPath {
        ...
        path.addCurve(to: CGPoint(x: centerWidth, y: height - 40),
                      controlPoint1: CGPoint(x: (centerWidth - 20), y: 0), controlPoint2: CGPoint(x: centerWidth - 20, y: height - 40))
        path.addCurve(to: CGPoint(x: (centerWidth + height), y: 0),
                      controlPoint1: CGPoint(x: centerWidth + 20, y: height - 40), controlPoint2: CGPoint(x: (centerWidth + 20), y: 0))
