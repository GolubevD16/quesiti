...
class WelcomeViewController: UIViewController {
    ...
    let welcomePages = [
        WelcomePage(imageName: "Logo", topicText: "Задай вопрос по-новому", descriptionText: ""),
        WelcomePage(imageName: "Question", topicText: "Удобство", descriptionText: "Спрашивай только тех, кого хочешь"),
        WelcomePage(imageName: "MapsHome", topicText: "Карта", descriptionText: "Задавай вопросы людям по всему миру"),
        WelcomePage(imageName: "Radius", topicText: "Рядом", descriptionText: "Возможность получить ответ только от людей находящихся в определенном месте"),
        WelcomePage(imageName: "", topicText: "Начнем", descriptionText: "")
    ]
    ...
    private func setupCollectionView() {
        ...
        collectionView.register(WelcomCell.self, forCellWithReuseIdentifier: "cellId")
        let constraints = [
    ...
    @objc private func animateLogoLabel(){
        ...
        UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0, options: .curveEaseIn, animations: {
            ...
            let controller = DimaSignUpViewController()
